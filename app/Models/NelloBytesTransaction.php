...
class NelloBytesTransaction extends Model
{
    protected $table = 'nellobytes_transactions';

    protected $guarded = ['id'];

    protected $casts = [
        'service_type' => NelloBytesServiceType::class,
     ...
     */
    public function scopeByServiceType($query, NelloBytesServiceType $serviceType)
    {
